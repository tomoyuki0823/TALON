...
public class StringCheckUtil {
    ...
    /**
     * 指定された文字列が有効なメールアドレス形式かどうかを判定します。
     *
     * <p>例:
     * <pre>{@code
     * StringCheckUtil.isEmail("test@example.com"); // true
     * StringCheckUtil.isEmail("invalid-email");    // false
     * }</pre>
     *
     * @param str チェック対象の文字列
     * @return 有効なメールアドレス形式であれば true、そうでなければ false
     */
    ...
    /**
     * 指定された文字列が英数字（半角英字・数字のみ）で構成されているかを判定します。
     *
     * <p>例:
     * <pre>{@code
     * StringCheckUtil.isAlphanumeric("abc123"); // true
     * StringCheckUtil.isAlphanumeric("abc_123"); // false
     * }</pre>
     *
     * @param str チェック対象の文字列
     * @return 英数字のみで構成されていれば true、そうでなければ false
     */
